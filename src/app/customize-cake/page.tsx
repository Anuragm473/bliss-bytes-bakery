  ...
  "@graph": [
    {
      ...
      description: "Premium eggless bakery in Kolkata offering custom cakes, photo cakes, and theme cakes with same-day delivery.",
      address: { "@type": "PostalAddress", addressLocality: "Kolkata", addressRegion: "West Bengal", addressCountry: "IN" },
      url: "https://blissbiteskolkata.com",
    ...
    },
    {
      ...
      provider: { "@type": "Bakery", name: "Bliss Bites Bakery" },
      areaServed: "Kolkata",
      description: "Order custom eggless cakes for birthdays, anniversaries, weddings and more in Kolkata.",
    },
  ],
};
